...
The return value from the `typeof` operator is always one of five (six as of ES6! - the "symbol" type) string values. That is, `typeof "abc"` returns `"string"`, not `string`.
